...
class XmippProtRansacFluo3D(ProtInitialVolume):
    """ 
    Computes an initial 3d model from a set of fluorescence volumes/classes 
    using RANSAC algorithm.
    
    This method is based on an initial non-linear dimensionality
    ...
    def _defineParams(self, form):
        ...
        form.addParam('inputSet', PointerParam, label="Input averages", important=True, 
                      pointerClass='SetOfClasses, SetOfAverages',# pointerCondition='hasRepresentatives',
                      help='Select the input images from the project.'
                           'It should be a SetOfClasses3D object')  
