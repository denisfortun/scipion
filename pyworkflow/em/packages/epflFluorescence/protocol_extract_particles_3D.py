...
from pyworkflow.em.packages.xmipp3.convert import writeSetOfCoordinates, readSetOfParticles, micrographToCTFParam
...
class ProtExtractParticles3D(ProtExtractParticles, XmippProtocol):
